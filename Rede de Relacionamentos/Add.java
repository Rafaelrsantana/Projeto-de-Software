...
public class Add {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("Seja bem vindo(a) ao iFace! Digite a opcao que voce deseja executar: editar perfil, adicionar amigos, enviar mensagem, criar/entrar em uma comunidade, recuperar informacoes, encerrar conta, privacidade, ou sair.");
            ...
            while (opcao2.equals("sair") == false) {
                if (opcao2.equals("editar perfil")) {
                    ...
                    System.out.println(
                            "Voce deseja enviar uma mensagem para um amigo, comunidade ou no feed de noticias? Digite a opcao que voce deseja executar: amigo, comunidade, feed.");
                    ...
                    if (opcao4.equals("amigo")) {
                        ...
                        interacao.setMessage(amigo, mensagens);
                        mensagens++;
                ...
                } else if (opcao2.equals("criar/entrar em uma comunidade")) {
                    System.out.println(
                            "Voce deseja criar ou entrar em uma comunidade? Digite a opcao que voce deseja executar: criar, entrar.");
                    String opcao5 = input.nextLine();
                    if (opcao5.equals("criar")) {
                        System.out.println("Digite o nome da comunidade que voce deseja criar: ");
                        String comunidade = input.nextLine();
                        interacao.setComunidade(comunidade, comunidades, account1.getUser());
                    ...
                    System.out.println(
                            "Digite a informação que voce deseja recuperar: perfil, amigos, mensagens, comunidades.");
                    ...
                    System.out.println(
                            "Voce realmente deseja encerrar sua conta? Digite a opcao que voce deseja executar: sim, nao");
                    String opcao7 = input.nextLine();
                    if (opcao7.equals("sim")) {
                        account1.encerrar();
                        interacao.finish();
                    ...
                    System.out.println(
                            "Voce deseja que todos os usuarios possam ver sua mensagens no feed ou somente amigos? Digite todos ou amigos.");
                ...
                System.out.println(
                        "Digite a opcao que voce deseja executar: editar perfil, adicionar amigos, enviar mensagem, criar/entrar em uma comunidade, recuperar informacoes sobre seu perfil, encerrar conta, privacidade, ou sair.");
